...
Declaración de adopción AOS para `anclora-private-estates`.

## Metadatos

- Repository Name: anclora-private-estates
...
`anclora-private-estates` forma parte del ecosistema Anclora como aplicación operativa Vite + React.
